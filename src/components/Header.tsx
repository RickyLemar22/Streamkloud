      ...
      <div className="flex items-center gap-x-3 lg:gap-x-6">
        ...
        {user ? (
          <div className="flex items-center gap-x-2 lg:gap-x-4">
            <Avatar 
              className="w-9 h-9 lg:w-11 lg:h-11 border-2 border-orange-500/20 cursor-pointer hover:border-orange-500/50 transition-colors"
              onClick={openProfile}
            >
            ...
            <Button 
              variant="outline" 
              onClick={logout}
              className="h-9 lg:h-11 border-zinc-800 bg-zinc-900 text-white hover:bg-zinc-800 rounded-xl gap-x-1 lg:gap-x-2 px-3 lg:px-5 text-xs lg:text-sm font-medium transition-all active:scale-95"
            >
              <LogOut className="w-3.5 h-3.5 lg:w-4.5 lg:h-4.5" />
              <span>Logout</span>
            </Button>
          </div>
        ) : (
          <div className="flex items-center gap-x-2 lg:gap-x-4">
            <Button 
              ...
              className="text-zinc-100 hover:text-white hover:bg-zinc-900/50 rounded-full px-4 lg:px-6 h-10 lg:h-12 text-sm lg:text-base font-bold transition-all active:scale-95"
            >
              Sign up
            </Button>
            <Button 
              onClick={() => openAuth('login')}
              className="bg-warm-gradient text-zinc-950 font-black rounded-full px-6 lg:px-10 h-10 lg:h-12 text-sm lg:text-base shadow-xl shadow-orange-500/30 ring-2 ring-orange-500/20 hover:ring-orange-500/50 transition-all active:scale-95"
            >
              Log in
            </Button>
          </div>
